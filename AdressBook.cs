...
class AddressBookSystem
{
    ...
    public void SearchByCity(string city)
    {
        ...
        {
            List<Contact> contactsInCity = addressBook.SearchByCity(city);
            searchResults.AddRange(contactsInCity);
        }
        ...
        {
            Console.WriteLine("Search results in the specified city:");
    ...
    public void SearchByState(string state)
    {
        ...
        foreach (var addressBook in addressBooks.Values)
        {
            List<Contact> contactsInState = addressBook.SearchByState(state);
            searchResults.AddRange(contactsInState);
        }
        ...
        {
            Console.WriteLine("Search results in the specified state:");
            foreach (var contact in searchResults)
            {
                Console.WriteLine("Contact Name: {0} {1}", contact.FirstName, contact.LastName);
                Console.WriteLine("Address: {0}", contact.Address);
